...
// HIRE Painter
router.get("/tutorHari", function (req, res, next) {
  res.render("tutorHari",{isLoggedIn: req.isAuthenticated(),logoutMessage: req.flash("logoutmessage")});
});

router.post("/tutorHari", function (req, res, next) {
  const {
    address,
    phonenumber,
    dateOfHire,
