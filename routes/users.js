...
router.post("/login", (req, res, next) => {
  ...
  passport.authenticate("local", {
    ...
    failureMessage: "invalid subject. Please try again!",
    failureFlash: true,
  })(req, res, next);
});
// Login Ends
...
//SignUp Begins
router.get("/BecomeTutor", function (req, res) {
  res.render("BecomeTutor", { title: "BecomeTutor" });
});


router.post("/BecomeTutor", function (req, res) {
  // console.log(req.body);
  const {
    username,
    email,
